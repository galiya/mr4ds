...
default_logit_scored <- rxPredict(default_model_logit,
                                   mort_split$validate,
                                   "scored.xdf", #difference between open-source R Predict function and MRS implementation
                                  writeModelVars = TRUE, #not only write predictions, but also see how they came about
...
default_gbm_scored <- rxPredict(default_model_gbm,
                                  mort_split$validate,
                                 "scored.xdf",
                                predVarNames = c("pred_gbm_default2"))
